namespace DesktopApp
{
    partial class Administrator
    {
        ...
        private void InitializeComponent()
        {
			...
			// TittelPanel
			// 
			this.TittelPanel.BackColor = System.Drawing.Color.DodgerBlue;
			this.TittelPanel.Controls.Add(this.BackpictureBox);
			this.TittelPanel.Controls.Add(this.minimizepictureBox);
			this.TittelPanel.Controls.Add(this.closepictureBox);
			...
			// panel1
			// 
			this.panel1.Controls.Add(this.PasspictureBox);
			this.panel1.Controls.Add(this.UserpictureBox);
			this.panel1.Controls.Add(this.panel3);
			this.panel1.Controls.Add(this.panel2);
			this.panel1.Controls.Add(this.label3);
			this.panel1.Controls.Add(this.label2);
			this.panel1.Controls.Add(this.Hyni_button);
        ...
        private System.Windows.Forms.Panel TittelPanel;
